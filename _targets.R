...
list(
  ...
  tar_target(bdqc_species, read.csv(bdqc_csv) |> dplyr::filter(rank == "species")),
  ...
  tar_target(bold_saved, {
    writeLines(bold_raw, "results/bold_qc_data.tsv")
    "results/bold_qc_data.tsv"
  }, format = "file"),
  ...
  tar_target(ncbi_results_saved, {
    ...
    "results/ncbi_results.rds"
  }, format = "file"),
  tar_target(deficient_queries_saved, {
    saveRDS(ncbi_voucher$deficient_queries, "results/deficient_queries.rds")
    "results/deficient_queries.rds"
  }, format = "file"),
  tar_target(high_id_queries_saved, {
    saveRDS(ncbi_voucher$high_id_queries, "results/high_id_queries.rds")
    "results/high_id_queries.rds"
  }, format = "file"),
  ...
  tar_target(ncbi_non_voucher_results_saved, {
    saveRDS(ncbi_non_voucher$results, "results/ncbi_non_voucher_results.rds")
    "results/ncbi_non_voucher_results.rds"
  }, format = "file"),
  tar_target(deficient_queries_non_voucher_saved, {
    saveRDS(ncbi_non_voucher$deficient_queries, "results/deficient_queries_non_voucher_results.rds")
    "results/deficient_queries_non_voucher_results.rds"
  }, format = "file"),
  tar_target(high_id_queries_non_voucher_saved, {
    saveRDS(ncbi_non_voucher$high_id_queries, "results/high_id_queries_non_voucher_results.rds")
    "results/high_id_queries_non_voucher_results.rds"
  }, format = "file"),
  ...
  # ---- 4. NCBI full genomes -----------------------------------------------
  tar_target(ncbi_genomes, QCGenomLandscape::fetch_ncbi_genomes(bdqc_species$species)),
  tar_target(ncbi_genome_results_saved, {
    saveRDS(ncbi_genomes, "results/ncbi_genome_results.rds")
    "results/ncbi_genome_results.rds"
  }, format = "file"),
  ...
  tar_target(genes_saved, {
    saveRDS(gene_annotations, "results/genes_subsamp_50_df.rds")
    "results/genes_subsamp_50_df.rds"
  }, format = "file"),
  ...
  tar_target(gene_prevalence_saved, {
    ggplot2::ggsave("results/genes_prevalence.svg", gene_prevalence_plot, width = 18, height = 18)
    "results/genes_prevalence.svg"
  }, format = "file"),
  ...
  tar_target(risk_status_saved, {
    ggplot2::ggsave("results/risk_status_coverage.svg", risk_status_plot, width = 16, height = 10)
    "results/risk_status_coverage.svg"
  }, format = "file"),
